...
//Joseph Thayer
	...
	include "HeaderFooter/footer.php";
							...
							$result = $pdo->query("SELECT COUNT(*) FROM pending"); //count rows to get # of iterations
							$row = $result->fetch();
							...
							echo ' <a href = "changeStarted.php?task_id= ' . $var .'">Mark as started</a> &nbsp; &nbsp &nbsp'; //links to move and delete tasks
